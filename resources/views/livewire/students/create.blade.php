              ...
              <form role="form" wire:submit.prevent="addStudent()">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <div class="form-group flex-grow-1 mr-2">
                            ...
                            <input 
                                ...
                                type="text" class="form-control" placeholder="Date de Naissance" autocomplete="off"
                               >
                    ...
                    <div class="d-flex">
                        <div class="form-group flex-grow-1 mr-2">
                            <label >Sexe</label>
                            <input type="text" wire:model="newStudent.sexe" class="form-control @error('newStudent.sexe') is-invalid @enderror">

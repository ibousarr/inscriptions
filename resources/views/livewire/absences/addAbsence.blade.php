    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><h2><b>Classe : {{$this->classeName}}</b></h2>.</h5>
            </div>
            <div class="modal-body">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" wire:submit.prevent="addAbsenceClasse()">
                <div class="card-body bg-gray">
                    ...
                    <div class="d-flex">
                        <div class="form-group flex-grow-1 mr-2">
                            <label >Eleve</label>
                            @php
                                $inscriptions = \App\Models\Inscription::with('student', 'classeRoom')->whereRelation('classeRoom', 'id', $absenceClasse)->get();
                            @endphp
                            <select class="form-control @error('newAbsence.student_id') is-invalid @enderror" wire:model="newAbsence.student_id">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="form-group flex-grow-1 mr-2">
                            <label ></label>
                            <input disabled="true" type="text" class="form-control @error('newAbsence.clase_room_id') is-invalid @enderror" wire:model="absenceClasse">
                        ...
                        <div class="form-group flex-grow-1 mr-2">
                            <label ></label>
                            <input disabled="true" type="text" class="form-control @error('newAbsence.user_id') is-invalid @enderror" wire:model="newAbsence.user_id">
                        ...
                        <div class="form-group flex-grow-1 mr-2">
                            ...
                            <input disabled="true" type="text" class="form-control" value="{{auth()->user()->prenom}} {{auth()->user()->nom}} " >
            ...
            <div class="modal-footer bg-info">
                <button type="button" class="btn btn-danger" wire:click="closeAbsenceModal">
                        Annuler
                </button>
            </div>
        </div>
